...
//3.
//functie de cautarea in lista principala dupa ID //adica daca am lista cu id urile 1,2,3,4,5,6 am nevoie sa imi returneze spre ex adresa lui 3 
NodListaPrincipala *cautaNodDupaID(NodListaPrincipala* listaPrincipala, int id) {
	...
	// cat tp ma deplasez si e dif de id pe care l caut e ok 
...
NodListaPrincipala inserareMuchie(NodListaPrincipala* listaPrincipala, int idStart, int idStop) {
	...
	//if(!idStart || !idStop) {
	//	printf("Nu exista nodurile %d sau %d in lista principala\n", idStart, idStop);
	//	return listaPrincipala;
